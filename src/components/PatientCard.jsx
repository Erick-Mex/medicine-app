...
export default function PatientCard({ patient }) {
  ...
  return (
    <Link to={`/patient/${patient.Id}`} className='grid gap-1 grid-cols-3 grid-rows-3 bg-white rounded-md p-2 hover:drop-shadow-lg hover:bg-slate-200 hover:cursor-pointer'>
